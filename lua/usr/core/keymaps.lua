...
local bindings = {
    ...
    { "<leader>wss",        function() Snacks.scratch() end,                                        desc = "Toggle Scratch Buffer" },
    { "<leader>wsn",        function() Snacks.scratch.open() end,                                   desc = "New Scratch Buffer" },
    { "<leader>wsl",        function() Snacks.scratch.select() end,                                 desc = "Select Scratch Buffer" },
    { "<leader>wtt",        function() Snacks.terminal() end,                                       desc = "Toggle Terminal" },
    ...
    -- search/show
    { "<leader>sg",         function() Snacks.picker.grep({ args = { "-P" } }) end,                 desc = "Grep" },
